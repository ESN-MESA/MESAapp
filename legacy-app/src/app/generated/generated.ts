...
export type TumiEvent = {
  ...
  enablePhotoSharing: Scalars['Boolean'];
  end: Scalars['DateTime'];
  eventOrganizerId: Scalars['ID'];
  eventRegistrationCodes: Array<EventRegistrationCode>;
  eventTemplate: EventTemplate;
...
export type UpdateCoreEventInput = {
  ...
  enablePhotoSharing?: InputMaybe<Scalars['Boolean']>;
  end?: InputMaybe<Scalars['DateTime']>;
  eventOrganizerId: Scalars['ID'];
...
export type UpdateEventLocationInput = {
  ...
  isVirtual: Scalars['Boolean'];
  location: Scalars['String'];
  onlineMeetingUrl?: InputMaybe<Scalars['String']>;
};
...
export type UpdateTemplateLocationMutation = { __typename?: 'Mutation', updateTemplateLocation: { __typename?: 'EventTemplate', id: string, location: string, coordinates?: any | null, googlePlaceUrl?: string | null, isVirtual: boolean, onlineMeetingUrl?: string | null } };
...
export type UpdateEventLocationMutation = { __typename?: 'Mutation', updateEventLocation: { __typename?: 'TumiEvent', id: string, location: string, coordinates?: any | null, isVirtual: boolean, onlineMeetingUrl?: string | null } };
...
export type GetRegistrationCodeInfoQuery = { __typename?: 'Query', eventRegistrationCode: { __typename?: 'EventRegistrationCode', id: string, status: RegistrationStatus, registrationCreated?: { __typename?: 'EventRegistration', id: string, belongsToCurrentUser: boolean, transactions: Array<{ __typename?: 'Transaction', id: string, status: TransactionStatus, direction: TransactionDirection, amount: any, type: TransactionType, subject: string, stripePayment?: { __typename?: 'StripePayment', id: string, status: string, checkoutUrl?: string | null } | null }> } | null, targetEvent: { __typename?: 'TumiEvent', id: string, registrationMode: RegistrationMode, title: string, start: any, prices?: any | null } } };
